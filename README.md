...
- `sssh_publish_unit`:上網公告表單「發布單位」下拉要選的單位(擇一,須與站上該下拉**實際**選項文字一致)。可選項由校網後台的帳號群組決定、會變動(2026-09-23 實測 robot 帳號只剩「圖書館」「網管中心」);填錯時程式不會發佈,會在 run.log 印出「站上可選=[...]」,照那份清單改即可。
